...
var NavigationRoutesModule = /** @class */ (function () {
    function NavigationRoutesModule() {
    }
    NavigationRoutesModule.decorators = [
        { type: NgModule, args: [{
                    imports: [
    ...
    /** @nocollapse */
    NavigationRoutesModule.ctorParameters = function () { return []; };
    return NavigationRoutesModule;
}());
export { NavigationRoutesModule };
